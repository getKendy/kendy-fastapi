...
def Start24hTicker():
    ...
    if not data:
        ...
        def handleTickerMessage(msg):
            saveTickerMessage.delay(tickers=msg)

        def handelKlinesMessage(msg):
            print(msg)

        twm.start_miniticker_socket(
            callback=handleTickerMessage, update_time=1000)
